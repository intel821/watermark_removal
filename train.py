# -*- coding: utf-8 -*-
"""
Created on Thu Jun  3 21:37:03 2021
...
# Path
_SAVE_PATH          =       'weights/Places365_val/WMR_'
_LOAD_PATH          =       'weights/Places365_val/WMR_0001.pt'
_TRAIN_SET_PATH     =       'img/Places365_val/train/'
...
start = time.time()
train_set = WaterMarkDataset(_TRAIN_SET_PATH, IMG_RESOLUTION)
    ...
    for batch_idx, (x, label) in enumerate(loop):
        ...
        if batch_idx % 50 == 0:
            ...
            with torch.no_grad():
                ...
                torchvision.utils.save_image(img_grid, f'./img/Places365_val/compare/{STEP:04d}.png')
