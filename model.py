# -*- coding: utf-8 -*-
"""
Created on Thu Jun  3 17:43:36 2021
            ...
            for name, module in self.named_children():
                if name == 'upsample_' + str(i+1):
                    if i == 0:
                        ...
                        # print(out.size(), intermediate_result[-i].size())
                        out = module(out + intermediate_result[-i])

        out = self.conv_final(out + intermediate_result[0])
        return out
